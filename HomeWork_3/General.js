...
console.log(isArrayA([1,2,3,4,5,6]))
console.log(isArrayA('[1,2,3,4,5,6]'))
// console.log(isArrayA(1))
// console.log(isArrayA(undefined))
// console.log(isArrayA([1,2,3,4,5,6]))
...
function prefillArray(cont,elem){
    const array = []
 ...
 console.log(prefillArray(5,'asdasd'))

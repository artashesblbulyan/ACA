...
function somFemales(employees){

    return employees.some(elem => elem.gender === "Female" )

}
console.log(somFemales(employees))


// 40. Write a function that will ensure that there are engineers in
// the list of employees

function someEngineer(employees){

    return employees.some(elem => elem.isEngineer)

}
console.log(someEngineer(employees))